...
async function go() {
    ...
    await vk.upload.photoAlbum({source: ['./photo.jpg', './photo.jpg', './photo.jpg', './photo.jpg', './photo.jpg'], values: {value: './photo.jpg', filename: 'photo', contentType: 'image'}, album_id: require('./config.json').album_id});i+=5; // Загружаем фотографию в альбом
